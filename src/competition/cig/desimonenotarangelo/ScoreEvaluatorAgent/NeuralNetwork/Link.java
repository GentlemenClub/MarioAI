...
public class Link
{
  ...
  public Neuron getIn() { return in; }
  public Neuron getOut() { return out; }
  public double getWeight() { return weights.get(this);}
 
  public void setWeight(double weight) { weights.put(this,weight); }
